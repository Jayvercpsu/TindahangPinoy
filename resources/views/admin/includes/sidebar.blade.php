...
<section id="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li>
            ...
            <ul class="side-dropdown">
                <li><a href="#" class="{{ Route::currentRouteName() == 'admin.view-orders' ? 'active' : '' }} text-decoration-none"><i class='bx bx-list-check'></i> View Orders</a></li>
                <li><a href="#" class="{{ Route::currentRouteName() == 'admin.pending-orders' ? 'active' : '' }} text-decoration-none"><i class='bx bx-loader-circle'></i> Pending Orders</a></li>
                <li><a href="#" class="{{ Route::currentRouteName() == 'admin.completed-orders' ? 'active' : '' }} text-decoration-none"><i class='bx bx-check-circle'></i> Completed Orders</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="side-dropdown">
                <li><a href="#" class="{{ Route::currentRouteName() == 'admin.view-sales' ? 'active' : '' }} text-decoration-none"><i class='bx bx-show'></i> View Sales</a></li>
                <li><a href="#" class="{{ Route::currentRouteName() == 'admin.process-refunds' ? 'active' : '' }} text-decoration-none"><i class='bx bx-undo'></i> Process Refunds</a></li>
            </ul>
        </li>
